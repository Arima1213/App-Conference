				...
				@if ($participant)
					@if (!isset($qrCodeUrl))
						<div class="text-center">
							<h2 class="text-xl font-semibold text-gray-700 dark:text-gray-200">Payment Required</h2>
							<p class="mt-2 text-base text-gray-500 dark:text-gray-400">
								Please complete your payment to access the QR Code for attendance confirmation.
							</p>
						</div>
					@else
						<div class="flex h-full flex-col justify-center space-y-6 md:h-[350px] md:items-start md:justify-center">
							...
							<div class="flex items-center space-x-3">
								<a href="{{ $qrCodeUrl }}" download="participant-registration-qr.png"
									style="
                                        display:inline-flex;
                                        align-items:center;
