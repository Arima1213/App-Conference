...
<!-- Mirrored from html.rovadex.com/html-giner/conference-page.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 20 Jun 2025 15:09:42 GMT -->
...
<body id="conference-page" style="background-image: url(assets/img/conference_bg.svg);">
	...
	<section class="s-conference-slider">
		<div class="conference-slider">
			<div class="conference-slide" style="background-image: url(assets/img/slide1-home-2.jpg);">
				<img class="conference-slide-tringle" src="assets/img/effect-tringle-slider.svg" alt="img">
				<img class="conference-slide-effect" src="assets/img/effect-slider-left.svg" alt="img">
				<div class="container">
			...
			<div class="conference-slide" style="background-image: url(assets/img/slide4-home-2.jpg);">
				<img class="conference-slide-tringle" src="assets/img/effect-tringle-slider.svg" alt="img">
				<img class="conference-slide-effect" src="assets/img/effect-slider-left.svg" alt="img">
				<div class="container">
					<div class="conference-slide-item">
			...
			<div class="conference-slide" style="background-image: url(assets/img/slide3-home-2.jpg);">
				<img class="conference-slide-tringle" src="assets/img/effect-tringle-slider.svg" alt="img">
				<img class="conference-slide-effect" src="assets/img/effect-slider-left.svg" alt="img">
				<div class="container">
					<div class="conference-slide-item">
				...
				<div class="row">
					...
					<div class="col-lg-6 our-mission-info">
						...
						<div class="mission-info-text">
							<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusm od tempor incididunt ut labore et dolore magna aliqua. Ut enim minim
		...
		<div class="container">
			...
			<div class="speakers-timeline-cover">
				<div class="speakers-timeline-item">
					<div class="speakers-timeline-img">
						<a href="conference-team.html" class="our-speaker-item">
							<img class="rx-lazy" src="assets/img/placeholder-all.png" data-src="assets/img/speaker-1.jpg" alt="img">
				...
				<div class="speakers-timeline-item">
					<div class="speakers-timeline-img">
						<a href="conference-team.html" class="our-speaker-item">
							<img class="rx-lazy" src="assets/img/placeholder-all.png" data-src="assets/img/speaker-2.jpg" alt="img">
							<div class="speaker-item-info">
				...
				<div class="speakers-timeline-item">
					<div class="speakers-timeline-img">
						<a href="conference-team.html" class="our-speaker-item">
							<img class="rx-lazy" src="assets/img/placeholder-all.png" data-src="assets/img/speaker-3.jpg" alt="img">
							<div class="speaker-item-info">
				...
				<div class="speakers-timeline-item">
					<div class="speakers-timeline-img">
						<a href="conference-team.html" class="our-speaker-item">
							<img class="rx-lazy" src="assets/img/placeholder-all.png" data-src="assets/img/speaker-4.jpg" alt="img">
							<div class="speaker-item-info">
	...
	<!--================= S-HAVE-PREPARED =================-->
	<section class="s-have-prepared counter-animate counter-active" style="background-image: url(assets/img/bg-headway.jpg);">
		<div class="container">
			...
			<div class="row">
				<div class="col-6 col-sm-3 have-prepared-item">
					<div class="have-prepared">
						<img src="assets/img/tringle-blue.svg" alt="img">
	...
	<section class="s-instagram">
		<div class="instagram-cover">
			<a href="#" class="instagram-item">
				...
				<img class="rx-lazy" src="assets/img/placeholder-all.png" data-src="assets/img/conference-insta-1.jpg" alt="img">
			</a>
			<a href="#" class="instagram-item">
				<ul>
				...
				<img class="rx-lazy" src="assets/img/placeholder-all.png" data-src="assets/img/conference-insta-2.jpg" alt="img">
			</a>
			<a href="#" class="instagram-item">
				<ul>
				...
				<img class="rx-lazy" src="assets/img/placeholder-all.png" data-src="assets/img/conference-insta-3.jpg" alt="img">
			</a>
			<a href="#" class="instagram-item">
				<ul>
				...
				<img class="rx-lazy" src="assets/img/placeholder-all.png" data-src="assets/img/conference-insta-4.jpg" alt="img">
			</a>
			<a href="#" class="instagram-item">
				<ul>
				...
				<img class="rx-lazy" src="assets/img/placeholder-all.png" data-src="assets/img/conference-insta-5.jpg" alt="img">
			</a>
			<a href="#" class="instagram-item">
				<ul>
					<li class="comments">350 <i class="far fa-comment"></i></li>
				...
				<img class="rx-lazy" src="assets/img/placeholder-all.png" data-src="assets/img/conference-insta-6.jpg" alt="img">
			</a>
			<a href="#" class="instagram-item">
				<ul>
					<li class="comments">350 <i class="far fa-comment"></i></li>
				...
				<img class="rx-lazy" src="assets/img/placeholder-all.png" data-src="assets/img/conference-insta-7.jpg" alt="img">
			</a>
			<a href="#" class="instagram-item">
				<ul>
					<li class="comments">350 <i class="far fa-comment"></i></li>
				...
				<img class="rx-lazy" src="assets/img/placeholder-all.png" data-src="assets/img/conference-insta-8.jpg" alt="img">
			</a>
			<a href="#" class="instagram-item">
				<ul>
					<li class="comments">350 <i class="far fa-comment"></i></li>
				...
				<img class="rx-lazy" src="assets/img/placeholder-all.png" data-src="assets/img/conference-insta-9.jpg" alt="img">
			</a>
			<a href="#" class="instagram-item">
				<ul>
					<li class="comments">350 <i class="far fa-comment"></i></li>
				...
				<img class="rx-lazy" src="assets/img/placeholder-all.png" data-src="assets/img/conference-insta-10.jpg" alt="img">
			</a>
		</div>
	</section>
	<!--================ S-INSTAGRAM END ================-->
		...
		<div class="container">
			<div class="row">
				...
				<div class="footer-subscribe col-12 col-sm-6 col-lg-4">
					...
					<p>By clicking the button you agree to the <a href="#" target="_blank">Privacy Policy</a> and <a href="#" target="_blank">Terms
							and Conditions</a></p>
				</div>
			</div>
		</div>
...
<!-- Mirrored from html.rovadex.com/html-giner/conference-page.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 20 Jun 2025 15:09:50 GMT -->
